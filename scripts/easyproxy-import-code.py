...
IMPORT_CODE_PREFIX = "easyproxy-import-v1."
...
def decode_import_code(import_code: str) -> dict[str, Any]:
    ...
    if payload.get("kind") != "easyproxy-import-code":
...
def bundle_for_import_code(import_code: str, payload: dict[str, Any]) -> dict[str, Any]:
    return {
        "schemaVersion": 1,
        "kind": "easyproxy-import-code-bundle",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate, inspect, encrypt, and decrypt EasyProxy distribution import codes.")
