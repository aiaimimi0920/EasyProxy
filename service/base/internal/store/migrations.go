...
`,
		...
		{
			Version:     3,
			Description: "add traffic-proven and probe timestamp columns to node_stats",
			Up: `
ALTER TABLE node_stats ADD COLUMN traffic_success_count INTEGER NOT NULL DEFAULT 0;
ALTER TABLE node_stats ADD COLUMN last_traffic_success_at TEXT NOT NULL DEFAULT '';
ALTER TABLE node_stats ADD COLUMN last_probe_at TEXT NOT NULL DEFAULT '';
